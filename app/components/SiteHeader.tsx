    ...
    <header className="sticky top-0 z-50 border-b border-[#EEF1F5] bg-white/90 backdrop-blur">
      <div className="mx-auto flex h-[52px] max-w-[1360px] items-center justify-between px-5 sm:h-[60px]">
        ...
        <div className="flex items-center gap-4 sm:gap-7">
          ...
          <CtaLink href="/pricing" location="header" className="rounded-md bg-[#3182F6] px-3.5 py-2 text-[13px] font-semibold text-white transition hover:bg-[#1B64DA] sm:px-4 sm:text-[14px]">
            인재 추천받기
          </CtaLink>
        </div>
      </div>
